...
const PricingPlanScreen = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Image
          source={require("../../assets/On_Core_Fitness_Images/on_core_fitness_image_14.png")}
          style={styles.heroImage}
        />
        <Text style={[styles.sectionTextOne, styles.logoCore]}>MEMBERSHIP</Text>
